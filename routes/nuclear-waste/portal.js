...
router.get('/', function(req, res, next) {
    ...
    var portalData = {
        ...
        portalUrl: req.protocol + '://' + req.get('host') + req.originalUrl,
        postUrl: req.protocol + '://' + req.get('host') + req.originalUrl.replace('portal', 'posts'),
        commentUrl: req.protocol + '://' + req.get('host') + req.originalUrl.replace('portal', 'posts/:post_id/comments'),
        ...
        statisticUrl: req.protocol + '://' + req.get('host') + req.originalUrl.replace('portal', 'posts/:post_id/statistics'),
    };
    res.json(portalData);
});
